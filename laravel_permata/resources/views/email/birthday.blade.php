                 ...
                 @switch($jenis_kelamin)
                  ...
                  @switch($nama_marga)
                      ...
                      @default
                          Iting 
                  @endswitch
                  , semoga di ulang tahun yang ke {{$umur}} tahun, tetap semangat, sehat selalu, jangan menyerah dan tetap ingat Tuhan, kamu diberkati jadi tersenyumlah. Berbagilah berkat dengan senyuman dan perbuatan baik, 
                  <br>
                  God Bless You :)                    
                  <br>
                  <br>
